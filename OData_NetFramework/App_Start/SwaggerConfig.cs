        ...
        public static void Register()
        {
            ...
            GlobalConfiguration.Configuration
                .EnableSwagger(c =>
                {
                    ...
                    //
                    c.SingleApiVersion("v1", "CommunityHub.WebApi");
...
/*
                ...
                .EnableSwaggerUi(c =>
                {
                    c.CustomAsset("logoImage", thisAssembly, "Logo.png");
                    ...
                    // Use the "InjectStylesheet" option to enricsh the UI with one or more additional CSS stylesheets.
                    // The file must be included in your project as an "Embedded Resource", and then the resource's
                    // "Logical Name" is passed to the method as shown below.
                    //
                    c.InjectStylesheet(thisAssembly, "Stylesheets.CustomSwagger.css");

                    // Use the "InjectJavaScript" option to invoke one or more custom JavaScripts after the swagger-ui
                    // has loaded. The file must be included in your project as an "Embedded Resource", and then the resource's
                    // "Logical Name" is passed to the method as shown above.
                    //
                    c.InjectJavaScript(thisAssembly, "Resources.Scripts.CustomSwagger.js");
